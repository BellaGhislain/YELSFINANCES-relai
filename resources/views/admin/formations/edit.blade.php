        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">Modifier la formation</h1>
                </div>
                <div class="col-auto">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10 mb-3 mb-lg-0">
                ...
                <div class="card mb-3 mb-lg-5">
                    ...
                    <!-- Body -->
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.formations.update', $formation->id) }}" enctype="multipart/form-data" id="formationForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="formationNameLabel" placeholder="Ex: Formation en Développement Web" value="{{ old('name', $formation->name) }}">
                                @error('name')
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select @error('level') is-invalid @enderror" name="level" id="levelsLabel">
                                    ...
                                    <option value="expert" {{ old('level', $formation->level) == 'expert' ? 'selected' : '' }}>Expert</option>
                                </select>
                                @error('level')
                       ...
                       <!-- Form: Compétences -->
                            <div class="mb-4">
                                ...
                                <div id="skillsItemsContainer">
                                    @foreach($formation->skills as $index => $skill)
                                        <div class="mb-3 skill-item">
                                            <div class="input-group">
                                                <input type="text" class="form-control @error('skillItem.*') is-invalid @enderror" name="skillItem[]" placeholder="Ex: Maîtriser les langages HTML, CSS et JavaScript" value="{{ old('skillItem.' . $index, $skill->name) }}">
                                                <button type="button" class="btn btn-outline-danger remove-skill-item" style="{{ $index == 0 ? 'display: none;' : 'display: block;' }}">
                                                    <i class="bi-trash"></i>
                                                </button>
                                            </div>
                                            @error('skillItem.*')
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('presentation') is-invalid @enderror" name="presentation" id="presentationLabel" rows="6" placeholder="Décrivez en détail le contenu de la formation, les objectifs, les prérequis, etc...">{{ old('presentation', $formation->presentation) }}</textarea>
                                @error('presentation')
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="url" class="form-control @error('youtube_link') is-invalid @enderror" name="youtube_link" id="youtubeLinkLabel" placeholder="https://www.youtube.com/watch?v=..." value="{{ old('youtube_link', $formation->youtube_link) }}" form="formationForm">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        @if ($formation->photo)
                                            <div class="mb-3">
                                                <img src="{{ Storage::url($formation->photo) }}" alt="Photo actuelle" class="img-fluid" style="max-width: 200px;">
                                                <p class="form-text">Photo actuelle. Téléchargez une nouvelle image pour la remplacer.</p>
                                            </div>
                                        @endif
                            ...
                            <div class="d-flex justify-content-end gap-3">
                                ...
                                <button type="submit" class="btn btn-primary" form="formationForm">Mettre à jour la formation</button>
                            </div>
                            <!-- End Buttons -->
                        </form>
                    </div>
